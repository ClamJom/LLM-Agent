...
from transformers import (AutoModelForCausalLM, AutoTokenizer,
                        Qwen2ForCausalLM, GenerationConfig)
...
class DeepseekLocal(BaseModel):
    ...
    def __init__(self, path, **kwargs):
        ...
        self.model: Qwen2ForCausalLM = AutoModelForCausalLM.from_pretrained(self.model_path)
    ...
    def __call__(self, prompt: str, **kwargs):
        ...
        input_tokens = self.tokenizer.apply_chat_template(self.messages, 
        ...
        while True:
            ...
            if self.tokenizer.eos_token_id in output_tokens[0]:
                final_result = self.tokenizer.decode(output_tokens[0, old_tokens_length:],
